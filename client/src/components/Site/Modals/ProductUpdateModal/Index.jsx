...
import { postProduct, updateProduct } from '../../../../redux/slices/producSlice';
import { jwtDecode } from 'jwt-decode';
const ProductUpdateModal = () => {
    const { openProdUpdateRef, handleCloseProductUpdate } = useDataContext()
    ...
    useEffect(() => {
        let initialState = {
            ...
            bidderId: oneProduct?.bidderId,
            afterPrice: oneProduct?.afterPrice,
            productPrice: oneProduct?.productPrice,
            minimumBidPrice: oneProduct?.minimumBidPrice,
            productName: oneProduct?.productName,
            productDescription: oneProduct?.productDescription,
            oneTimePurchase: oneProduct?.oneTimePurchase,
            watching: oneProduct?.watching,
            endTime: oneProduct?.endTime ? new Date(oneProduct.endTime).toISOString().slice(0, 16) : '',
            startTime: oneProduct?.startTime ? new Date(oneProduct.startTime).toISOString().slice(0, 16) : '',
            totalBids: oneProduct?.totalBids,
            productImages: oneProduct?.productImages || [],
        ...
        if (types) {
            if (types === 'car') {
                initialState.details = {
                    brand: oneProduct?.details?.brand,
                    condition: oneProduct?.details?.condition,
                    model: oneProduct?.details?.model,
                    year: oneProduct?.details?.year,
                    fuel: oneProduct?.details?.fuel,
                    color: oneProduct?.details?.color,
                    mileage: oneProduct?.details?.mileage,
                    engine: oneProduct?.details?.engine,
                    transmission: oneProduct?.details?.transmission,
                    doors: oneProduct?.details?.doors,
                };
            } else if (types === 'electronic') {
                initialState.details = {
                    prodBrand: oneProduct?.details?.prodBrand,
                    series: oneProduct?.details?.series,
                    prodColor: oneProduct?.details?.prodColor,
                    hardDiskSize: oneProduct?.details?.hardDiskSize,
                    cpuModel: oneProduct?.details?.cpuModel,
                    ramMemory: oneProduct?.details?.ramMemory,
                };
            } else if (types === 'jewelry') {
                initialState.details = {
                    weight: oneProduct?.details?.weight,
                    purity: oneProduct?.details?.purity,
                    gemstone: oneProduct?.details?.gemstone,
                    metalType: oneProduct?.details?.metalType,
                    claspType: oneProduct?.details?.claspType,
                    dimensions: {
                        length: oneProduct?.details?.dimensions?.length,
                        width: oneProduct?.details?.dimensions?.width,
                        height: oneProduct?.details?.dimensions?.height,
                    },
                    gemstoneColor: oneProduct?.details?.gemstoneColor,
                };
            }
        }
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            formData.append('bidderId', values.bidderId);
            formData.append('productName', values.productName);
            formData.append('productPrice', values.productPrice);
            formData.append('afterPrice', values.afterPrice);
            ...
            await dispatch(updateProduct({ id: oneProduct?._id, newData: formData }))
    ...
    return (
        <div className='updateBid' ref={openProdUpdateRef}>
            <div className="addBidBox">
                <div className="closeBtn" onClick={handleCloseProductUpdate}>
                    <IoClose />
                    ...
                    <form className="addBidBoxInsideBottom" onSubmit={formik.handleSubmit}>
                        <div className="addBidBoxItem">
                            <div className='addBidBoxItemInside'>
                                <label htmlFor="productNameU">Name:</label>
                                <input
                                    type="text"
                                    id="productNameU"
                                    name="productName"
                        ...
                        <div className="addBidBoxItem">
                            <div className='addBidBoxItemInside'>
                                <label htmlFor="minimumBidPriceU">Minimum Bid:</label>
                                <input
                                    type="number"
                                    min={1}
                                    id="minimumBidPriceU"
                        ...
                        <div className="addBidBoxItem">
                            <div className='addBidBoxItemInside'>
                                <label htmlFor="oneTimePurchaseU">One Time Purchase:</label>
                                <input
                                    type="number"
                                    min={1}
                                    id="oneTimePurchaseU"
                        ...
                        <div className="addBidBoxItem">
                            <div className='addBidBoxItemInside'>
                                ...
                                <div className="addBidFile col-xs-12">
                                    <input
                                        type="text" disabled value={selectedFiles.length > 0 ? `${selectedFiles.length} file(s) selected` : `${oneProduct?.productImages?.length} file(s) selected`} placeholder='Select Image(s)' />
                                    <span>
                        ...
                        <div className="addBidBoxItem">
                            <div className='addBidBoxItemInside'>
                                <label htmlFor="startTimeU">
                                    Auction Start Time:
                                </label>
                                <input value={formik.values.startTime} name='startTime' onChange={formik.handleChange}  type="datetime-local" id="startTimeU" />
                            
                            </div>
                        </div>
                        <div className="addBidBoxItem">
                            <div className='addBidBoxItemInside'>
                                <label htmlFor="endTimeU">
                                    Auction End Time:
                                </label>
                                <input value={formik.values.endTime} min={currentDateTime} name='endTime' onChange={formik.handleChange} onBlur={formik.handleBlur} type="datetime-local" id="endTimeU" />
                        ...
                        <div className="addBidBoxItem">
                            <div className='addBidBoxItemInside'>
                                <label htmlFor="productDescriptionU">Description:</label>
                                <textarea
                                    type="text"
                                    id="productDescriptionU"
                        ...
                        <div className="addBidBoxItem">
                            <div className='addBidBoxItemInside'>
                                <label htmlFor="typeU">Type:</label>
                                <select
                                    id="typeU"
                                    name="type"
                                    onChange={(e) => {
                        ...
                        {formik.values.type === 'car' && (
                            <div className="addBidItemsBox">
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.brandU">Brand:</label>
                                        <input
                                            type="text"
                                            id="details.brandU"
                                            name="details.brand"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.conditionU">Condition:</label>
                                        <input
                                            type="text"
                                            id="details.conditionU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.modelU">Model:</label>
                                        <input
                                            type="text"
                                            id="details.modelU"
                                            name="details.model"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.yearU">Year:</label>
                                        <input
                                            type="number"
                                            id="details.yearU"
                                            name="details.year"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.fuelU">Select Car Fuel Type:</label>
                                        <select
                                            id="details.fuelU"
                                            name="details.fuel"
                                            onChange={formik.handleChange}
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.colorU">Select Car Color:</label>
                                        <select
                                            id="details.colorU"
                                            name="details.color"
                                            onChange={formik.handleChange}
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.mileageU">Mileage:</label>
                                        <input
                                            type="number"
                                            id="details.mileageU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.engineU">Engine:</label>
                                        <input
                                            type="text"
                                            id="details.engineU"
                                            name="details.engine"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.transmissionU">Select Car Transmission:</label>
                                        <select
                                            id="details.transmissionU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.doorsU">Doors:</label>
                                        <input
                                            type="number"
                                            min={1}
                                            max={10}
                        ...
                        {formik.values.type === 'electronic' && (
                            <div className="addBidItemsBox">
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.prodBrandU">Brand:</label>
                                        <input
                                            type="text"
                                            id="details.prodBrandU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.seriesU">Series:</label>
                                        <input
                                            type="text"
                                            id="details.seriesU"
                                            name="details.series"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.prodColorU">Choose a Color:</label>

                                        <select
                                            id="details.prodColorU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.hardDiskSizeU">Select A Hard Disk Size:</label>

                                        <select
                                            id="details.hardDiskSizeU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.cpuModelU">Select A Cpu Model:</label>

                                        <select
                                            id="details.cpuModelU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.ramMemoryU">Select A Ram Size:</label>

                                        <select
                                            id="details.ramMemoryU"
                        ...
                        {formik.values.type === 'jewelry' && (
                            <div className="addBidItemsBox">
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.weightU">Weight:</label>
                                        <input
                                            type="number"
                                            id="details.weightU"
                                            name="details.weight"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.purityU">Select Gold Purity:</label>
                                        <select
                                            id="details.purityU"
                                            name="details.purity"
                                            onChange={formik.handleChange}
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.gemstoneU">Select Gemstone:</label>
                                        <select
                                            id="details.gemstoneU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.metalTypeU">Select Metal Type:</label>
                                        <select
                                            id="details.metalTypeU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.claspTypeU">Select a Clasp Type:</label>
                                        <select
                                            id="details.claspTypeU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.gemstoneColorU">Select Gemstone Color:</label>
                                        <select
                                            id="details.gemstoneColorU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.dimensions.lengthU">Product Length:</label>
                                        <input
                                            type="number"
                                            min={1}
                                            id="details.dimensions.lengthU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.dimensions.widthU">Product Width:</label>
                                        <input
                                            type="number"
                                            min={1}
                                            id="details.dimensions.widthU"
                                ...
                                <div className="addBidBoxItem">
                                    <div className='addBidBoxItemInside'>
                                        <label htmlFor="details.dimensions.heightU">Product Height:</label>
                                        <input
                                            type="number"
                                            min={1}
                                            id="details.dimensions.heightU"
