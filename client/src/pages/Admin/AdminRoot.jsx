...
import Sidebare from '../../layout/Admin/Sidebare/Index'
...
const AdminRoot = () => {
    ...
    return (
        <div style={{ position: 'relative', overflow: "hidden", display: location.pathname == '/admin/loginAdmin' || location.pathname == '/admin/adminRegister' ? '' : 'flex' }}>
            <AdminHeader />
            <Sidebare />
            <Outlet />
        </div>
